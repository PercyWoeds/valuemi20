...
$data_array = [];
   ...
   array_push($data_array, [
                        "unidad_de_medida"          => "ZZ",
                        "codigo"                    => "23",
                        "descripcion"               => "SERVICIO DE TRANSPORTE- GAS 98",
                        "cantidad"                  => "500.00",
                        "valor_unitario"            => "0.067",
                        "precio_unitario"           => "0.079",
                        "descuento"                 => "",
...
$data = array(
    ...
    "detraccion"                        => "false",
    "observaciones"                     => "LOCAL COMERCIAL: AV. NESTOR GAMBETTA LOTE. 1Y2 URB. IND. EX FUNDO OQUENDO
(CRUCE CON LA CALLE SEIS - ZETA GAS) PROV. CONST. DEL CALLAO -
PROV. CONST. DEL CALLAO - CALLAO - CORRESPONDIENTE MES FEBRERO 2020",
