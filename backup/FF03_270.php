...
$data = array(
    ...
    "cliente_numero_de_documento"	    => "20518518543",
    "cliente_denominacion"              => "CONSORCIO 22 SRL",
    "cliente_direccion"                 => "MZA. W LOTE. 6 URB. LAS PRADERAS DE STA ANIT (PQUE LOS MONTES) LIMA - LIMA - EL AGUSTINO",
    "cliente_email"                     => "",
    "cliente_email_1"                   => "",
    "cliente_email_2"                   => "",
    ...
    "condiciones_de_pago"               => "",
    "medio_de_pago"                     => "",
    "placa_vehiculo"                    => "D1U-905,C8R-875,ASX-801,BCB-706,D5P-892,F9S-727,D5E-719",
