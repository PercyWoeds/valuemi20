...
$data_array = [];
  ...
  // Loop through query and push results into $someArray;
    array_push($data_array, [
                        ...
                        "descripcion"               => "GAS 90",
                        "cantidad"                  => "906.485",
                        "valor_unitario"            => "9.623",
                        "precio_unitario"           => "11.36",
                        "descuento"                 => "",
                        "subtotal"                  => "8723.33",
                        "tipo_de_igv"               => "1",
                        "igv"                       => "1570.20",
  ...
  array_push($data_array, [
   ...
   array_push($data_array, [
                        ...
                        "descripcion"               => "GAS 98",
                        "cantidad"                  => "199.978",
                        "valor_unitario"            => "11.349",
                        "precio_unitario"           => "13.39",
                        "descuento"                 => "",
                        "subtotal"                  => "2269.50",
                        "tipo_de_igv"               => "1",
                        "igv"                       => "408.51",
