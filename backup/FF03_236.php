...
$data_array = [];
  ...
  array_push($data_array, [
                        ...
                        "descripcion"               => "GAS 90",
                        "cantidad"                  => "19.06",
                        "valor_unitario"            => "10.63",
                        "precio_unitario"           => "12.54",
                        "descuento"                 => "",
                        "subtotal"                  => "202.66",
                        "tipo_de_igv"               => "1",
                        "igv"                       => "36.48",
  ...
  array_push($data_array, [
                        ...
                        "descripcion"               => "GAS 95",
                        "cantidad"                  => "30.60",
                        "valor_unitario"            => "11.66",
                        "precio_unitario"           => "13.75",
                        "descuento"                 => "",
                        "subtotal"                  => "356.69",
                        "tipo_de_igv"               => "1",
                        "igv"                       => "64.20",
  ...
  array_push($data_array, [
                        ...
                        "cantidad"                  => "32.97",
                        "valor_unitario"            => "10.41",
                        "precio_unitario"           => "12.28",
                        "descuento"                 => "",
                        "subtotal"                  => "343.11",
                        "tipo_de_igv"               => "1",
                        "igv"                       => "61.76",
