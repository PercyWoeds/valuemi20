...
//Abrimos nuestro archivo
   ...
   // Cliente
		...
		$invoice = (new Invoice())
		    ...
		    ->setTipoMoneda('PEN')
		    ->setClient($client)		    
		    ->setMtoOperGravadas(floatval('557.19')) //VALOR VENTA 
		    ->setMtoIGV(floatval('100.29')) //IGV
		    ->setTotalImpuestos(floatval('100.29')) //IGV 
		    ->setValorVenta(floatval('557.19'))  // VALOR VENTA
		    ->setMtoImpVenta(floatval('657.48')) // IMPORTE TOTAL
		    ->setCompany($company);

		     $letras =  numtoletras('657.48') ;
		...
		$item = (new SaleDetail())
		    ...
		    ->setMtoBaseIgv(floatval('400.41'))
		    ->setPorcentajeIgv(18.00) // 18%
		    ->setIgv(floatval('72.07'))
		    ->setTipAfeIgv('10')
		    ->setTotalImpuestos(floatval('72.07'))
		    ->setMtoValorVenta(floatval('400.41'))
...
$item2 = (new SaleDetail())
		    ...
		    ->setMtoBaseIgv(floatval('118.64'))
		    ->setPorcentajeIgv(18.00) // 18%
		    ->setIgv(floatval('21.36'))
		    ->setTipAfeIgv('10')
		    ->setTotalImpuestos(floatval('21.36'))
		    ->setMtoValorVenta(floatval('118.64'))
...
$item3 = (new SaleDetail())
		    ...
		    ->setMtoBaseIgv(floatval('38.14'))
		    ->setPorcentajeIgv(18.00) // 18%
		    ->setIgv(floatval('6.86'))
		    ->setTipAfeIgv('10')
		    ->setTotalImpuestos(floatval('6.86'))
		    ->setMtoValorVenta(floatval('38.14'))
