...
$data_array = [];
 ...
 array_push($data_array, [
                        ...
                        "codigo"                    => "02",
                            "descripcion"               => "GAS 90 ",
                            "cantidad"                  => "400.00"   ,
                            "valor_unitario"            => "10.19",
                            "precio_unitario"           => "12.02",
                        "descuento"                 => "",
                        "subtotal"                  => "4074.58",
                        "tipo_de_igv"               => "1",
                        "igv"                       => "733.42",
...
$data = array(
    ...
    "cliente_direccion"                 => "CAL.A MZ.2 LTE.3 A.V.R. HAYA DE LA TORRE- INDEPENDENCIA - LIMA  ",
     "cliente_email"                     => "",
    "cliente_email_1"                   => "",
    "cliente_email_2"                   => "",
