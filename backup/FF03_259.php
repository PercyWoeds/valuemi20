...
$data_array = [];
  ...
  array_push($data_array, [
                        ...
                        "descripcion"               => "GAS 90",
                        "cantidad"                  => "63.19",
                        "valor_unitario"            => "10.73",
                        "precio_unitario"           => "12.66",
                        "descuento"                 => "",
                        "subtotal"                  => "677.86",
                        "tipo_de_igv"               => "1",
                        "igv"                       => "122.01",
...
array_push($data_array, [
                        ...
                        "descripcion"               => "GAS 95",
                        "cantidad"                  => "29.43",
                        "valor_unitario"            => "11.75",
                        "precio_unitario"           => "13.86",
                        "descuento"                 => "",
                        "subtotal"                  => "345.64",
                        "tipo_de_igv"               => "1",
                        "igv"                       => "62.21",
  ...
  array_push($data_array, [
   ...
   array_push($data_array, [
                        "unidad_de_medida"          => "LTR",
                        "codigo"                    => "08",
                        "descripcion"               => "GLP",
                        "cantidad"                  => "255.50",
                        "valor_unitario"            => "1.06",
                        "precio_unitario"           => "1.26",
                        "descuento"                 => "",
                        "subtotal"                  => "271.99",
                        "tipo_de_igv"               => "1",
                        "igv"                       => "48.96",
...
$data = array(
    ...
    "cliente_numero_de_documento"	    => "20603521391",
    "cliente_denominacion"              => "CONSTRUCCIONES CPSDP SAC",
    "cliente_direccion"                 => "MZA.N LTE.19 ASC SEÑOR DE LOS MILAGROS SAN MARTIN DE PORRES LIMA",
    "cliente_email"                     => "",
    "cliente_email_1"                   => "",
    "cliente_email_2"                   => "",
    "fecha_de_emision"                  => "2019-12-30",
    ...
    "condiciones_de_pago"               => "",
    "medio_de_pago"                     => "",
    "placa_vehiculo"                    => "F3G-712,BEL-515,BEN-697,AAJ-394",
