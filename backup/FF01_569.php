...
$data = array(
    ...
    "detraccion"                        => "false",
    "observaciones"                     => "AV. NESTOR GAMBETTA LOTE. 1Y2 URB. IND. EX FUNDO OQUENDO (CRUCE CON LA CALLE SEIS - ZETA GAS) PROV. CONST. DEL CALLAO - PROV. CONST. DEL CALLAO - CALLAO",
