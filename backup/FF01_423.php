...
$data_array = [];
  ...
  array_push($data_array, [
                        ...
                        "descripcion"               => "GAS 95",
                        "cantidad"                  => "5.00",
                        "valor_unitario"            => "11.60",
                        "precio_unitario"           => "13.69",
                        "descuento"                 => "",
                        "subtotal"                  => "58.01",
                        "tipo_de_igv"               => "1",
                        "igv"                       => "10.44",
...
$data = array(
    ...
    "cliente_numero_de_documento"	    => "20373756912",
    "cliente_denominacion"              => "EMPRESA DE TRANSPORTES DIAZ SRL",
    "cliente_direccion"                 => "AV. ANTUNEZ DE MAYOLO NRO. 2517 COO. SANTA APOLONIA LIMA - LIMA - SAN MARTIN DE PORRES-LIMA",
    "cliente_email"                     => "",
    "cliente_email_1"                   => "",
    "cliente_email_2"                   => "",
    "fecha_de_emision"                  => "2019-12-31",
    ...
    "condiciones_de_pago"               => "",
    "medio_de_pago"                     => "",
    "placa_vehiculo"                    => "AJC-699,D70-735,D5I-874,
F1B-881,M4V-736,C3X-939,    D0D-198
",
