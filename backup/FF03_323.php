...
$data_array = [];
 ...
 array_push($data_array, [
                        ...
                        "descripcion"               => "GAS 95",
                        "cantidad"                  => "6.338",
                        "valor_unitario"            => "11.435",
                        "precio_unitario"           => "13.49",
                        "descuento"                 => "",
                        "subtotal"                  => "72.48",
                        "tipo_de_igv"               => "1",
                        "igv"                       => "13.05",
...
$data = array(
    ...
    "cliente_numero_de_documento"	    => "20504750931",
    "cliente_denominacion"              => "ROLANDO MULTISERVICIOS SAC",
    "cliente_direccion"                 => "JR.CONDE DEL CASTELLAR 155 URB.LOS MOROCHUCOS - SURCO ",
    "cliente_email"                     => "",
    "cliente_email_1"                   => "",
    "cliente_email_2"                   => "",
    ...
    "condiciones_de_pago"               => "",
    "medio_de_pago"                     => "",
    "placa_vehiculo"                    =>"AWJ-885,D1I-877
BMC-436 ",
