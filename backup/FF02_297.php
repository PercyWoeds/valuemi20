...
$data_array = [];
  ...
  array_push($data_array, [
                        ...
                        "descripcion"               => "GAS 90",
                        "cantidad"                  => "349.98",
                        "valor_unitario"            => "10.97",
                        "precio_unitario"           => "12.94",
                        "descuento"                 => "",
                        "subtotal"                  => "3837.86",
                        "tipo_de_igv"               => "1",
                        "igv"                       => "690.82",
...
array_push($data_array, [
                        ...
                        "cantidad"                  => "1300.00",
                        "valor_unitario"            => "10.61",
                        "precio_unitario"           => "12.52",
                        "descuento"                 => "",
                        "subtotal"                  => "13793.22",
                        "tipo_de_igv"               => "1",
                        "igv"                       => "2482.78",
...
$data = array(
    ...
    "cliente_numero_de_documento"	    => "20602217508",
    "cliente_denominacion"              => "DIRECCION DE REDES INTEGRADAS DE SALUD LIMA NORTE",
    "cliente_direccion"                 => "CAL A MZA 2 LOTE 3 A.V.R.HAYA D LA TORRE INDENPENDENCIA-LIMA",
    "cliente_email"                     => "",
    "cliente_email_1"                   => "",
    "cliente_email_2"                   => "",
