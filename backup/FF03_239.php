...
$data_array = [];
  ...
  array_push($data_array, [
                        ...
                        "cantidad"                  => "25.08",
                        "valor_unitario"            => "12.36",
                        "precio_unitario"           => "14.59",
                        "descuento"                 => "",
                        "subtotal"                  => "310.10",
                        "tipo_de_igv"               => "1",
                        "igv"                       => "55.82",
...
$data = array(
    ...
    "cliente_numero_de_documento"	    => "20536811827",
    "cliente_denominacion"              => "JUAN GALINDO SLU SUCURSAL DEL PERU",
    "cliente_direccion"                 => "-",
    "cliente_email"                     => "",
    "cliente_email_1"                   => "",
    "cliente_email_2"                   => "",
