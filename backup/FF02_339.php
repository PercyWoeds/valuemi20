...
$data = array(
    ...
    "cliente_numero_de_documento"	    => "20544136454",
    "cliente_denominacion"              => "TRANSPORT RODRIK E.I.R.L.",
    "cliente_direccion"                 => "AV. TOMAS ALVA EDISON MZA. F LOTE. 9B LOT. INDUSTRIAL SANTA ROSA -IETAPA -ATE",
    "cliente_email"                     => "",
    "cliente_email_1"                   => "",
    "cliente_email_2"                   => "",
    ...
    "condiciones_de_pago"               => "",
    "medio_de_pago"                     => "",
    "placa_vehiculo"                    => "C9P-710,C8S-730,D8P-832 
F1H-872,F1H-859,F2R-886 ",
