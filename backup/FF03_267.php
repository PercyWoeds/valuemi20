...
$data_array = [];
  ...
  // Loop through query and push results into $someArray;
    ...
    array_push($data_array, [
                        ...
                        "cantidad"                  => "96.13",
                        "valor_unitario"            => "10.45",
                        "precio_unitario"           => "12.33",
                        "descuento"                 => "",
                        "subtotal"                  => "1004.41",
                        "tipo_de_igv"               => "1",
                        "igv"                       => "180.79",
...
$data = array(
    ...
    "cliente_direccion"                 => "PJ. TAMBOMACHAY NRO. 192 (2DO. PISO.) PROV. CONST. DEL CALLAO - PROV. CONST. DEL CALLAO - CALLAO",
    "cliente_email"                     => "",
    "cliente_email_1"                   => "",
    "cliente_email_2"                   => "",
    ...
    "condiciones_de_pago"               => "",
    "medio_de_pago"                     => "",
    "placa_vehiculo"                    => "D5E-719,D5P-892,BCB-706,D1U-905,F9S-727,ASX-801,D5P-892 ",
