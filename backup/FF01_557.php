...
$data_array = [];
 ...
 array_push($data_array, [
                        ...
                        "descripcion"               => "GAS 98 ",
                        "cantidad"                  => "7.24",
                        "valor_unitario"            => "11.72",
                        "precio_unitario"           => "13.83",
                        "descuento"                 => "",
                        "subtotal"                  => "84.80",
                        "tipo_de_igv"               => "1",
                        "igv"                       => "15.26",
...
$data = array(
    ...
    "cliente_direccion"                 => "JR. EL ANIS NRO. 3940 URB. NARANJAL (ALT KM 6 AUTOPISTA TUPAC AMARU SAN MARTIN DE PORRES ",
    "cliente_email"                     => "",
    "cliente_email_1"                   => "",
    "cliente_email_2"                   => "",
    "fecha_de_emision"                  => "2020-05-21",
    ...
    "condiciones_de_pago"               => "",
    "medio_de_pago"                     => "",
    "placa_vehiculo"                    => "A6K-935,AHZ-378
C6S,718,A6D-935",
